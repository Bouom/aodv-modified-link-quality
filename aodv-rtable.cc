...
// Ajoutez une référence à la matrice de qualité de lien
//extern LinkQualityMatrix g_linkQualityMatrix;
...
RoutingTableEntry::RoutingTableEntry(Ptr<NetDevice> dev,
    ...
    : m_ackTimer(Timer::CANCEL_ON_DESTROY),
      ...
      m_linkQuality(linkQuality),// Initialisez linkQuality ici
      m_iface(iface),
      m_flag(VALID),
      m_reqCount(0),
...
double 
RoutingTableEntry::GetLinkQuality() const
{
  return m_linkQuality;
}

void 
RoutingTableEntry::SetLinkQuality(double linkQuality)
{
